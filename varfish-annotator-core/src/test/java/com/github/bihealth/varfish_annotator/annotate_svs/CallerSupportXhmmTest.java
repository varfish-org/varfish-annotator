...
public class CallerSupportXhmmTest {
  ...
  void initEach() {
    ...
    callerSupport = new CallerSupportXhmm();
  }
  ...
  void testBuildSampleGenotype() {
    ...
    final String expected =
        "SampleGenotype{sampleName='SAMPLE', genotype='0', filters=[], genotypeQuality=null, pairedEndCoverage=null, pairedEndVariantSupport=null, splitReadCoverage=null, splitReadVariantSupport=null, averageMappingQuality=null, copyNumber=null, averageNormalizedCoverage=3.47, pointCount=null}";
